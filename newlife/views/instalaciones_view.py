        ...
        rx.chakra.vstack(
            ...
            rx.desktop_only(
                rx.chakra.grid(
                    ...
                    grid_item(2, 2, '/instalaciones/6.webp','Sala de Musculación'),
                    grid_item(2, 2, '/instalaciones/7.webp','Entrenamiento Funcional'),
                    grid_item(2, 2, '/instalaciones/5.webp','Fitness Grupal'),
                    template_rows="repeat(6, 1fr)",
